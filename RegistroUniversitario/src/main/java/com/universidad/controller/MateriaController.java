...
public class MateriaController {
    ...
    public ResponseEntity<Void> eliminarMateria(@PathVariable Long id) {
        // Si la materia no puede eliminarse (por ser prerrequisito), el servicio lanzará una excepción
        // que será manejada por el GlobalExceptionHandler devolviendo el error y mensaje adecuado.
        materiaService.eliminarMateria(id);
        return ResponseEntity.noContent().build(); // Solo se retorna 204 si la eliminación fue exitosa
    }

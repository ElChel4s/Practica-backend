...
public class EstudianteServiceImpl implements IEstudianteService { // Define la clase EstudianteServiceImpl que implementa la interfaz IEstudianteService
    ...
    public EstudianteDTO actualizarEstudiante(Long id, EstudianteDTO estudianteDTO) { // Método para actualizar un estudiante existente
        ...
        estudianteExistente.setEstado(estudianteDTO.getEstado()); // Actualiza el estado
        ...
        // Si el estado es ACTIVO, limpiar campos de baja lógica
        if ("activo".equalsIgnoreCase(estudianteDTO.getEstado())) {
            estudianteExistente.setUsuarioBaja(null);
            estudianteExistente.setFechaBaja(null);
            estudianteExistente.setMotivoBaja(null);
        } else if ("inactivo".equalsIgnoreCase(estudianteDTO.getEstado())) {
            // Si es inactivo, mantener los datos de baja si vienen

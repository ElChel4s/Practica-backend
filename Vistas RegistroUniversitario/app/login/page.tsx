      ...
      <div className="hidden md:flex md:w-1/2 bg-gradient-primary items-center justify-center">
        <div className="max-w-md p-8 text-white animate-fade-in">
          ...
          <p className="text-lg mb-8">
            Plataforma integral para la gestión educativa. Administra estudiantes, materias e inscripciones de manera
            eficiente.
          </p>
          <div className="space-y-4">
            ...
            <div className="flex items-center">
              ...
              <p>Administración de materias</p>
            </div>
            <div className="flex items-center">
              <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center mr-4">
                <svg
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md space-y-8 animate-slide-in-up">
          <div className="text-center">
            <h2 className="mt-6 text-3xl font-bold tracking-tight text-[#003366]">Iniciar sesión</h2>
